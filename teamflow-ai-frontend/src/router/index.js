...
const routes = [
  ...
  { path: '/join/:projectCode', component: () => import('../views/JoinProject.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'projects/:id/permissions', component: () => import('../views/PermissionMatrix.vue') },
      ...
      { path: 'projects/:id/ai', component: () => import('../views/AiReport.vue') },
      { path: 'projects/:id/statistics', component: () => import('../views/ProjectStatistics.vue') },
